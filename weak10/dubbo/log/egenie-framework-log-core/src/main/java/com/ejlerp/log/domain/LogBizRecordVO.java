 ...
 * @author paul
 */
public class LogBizRecordVO extends AbstractObject {
    ...
    */
    ...
    public LogBizRecordVO(String operationType, Long entityId, Long tenantId, Boolean usable) {
    ...
    public LogBizRecordVO() {
    }

    public static void propertyAfterSet(LogBizRecordVO logBizRecordDTO, LogBizModuleTypeEnum moduleType,
