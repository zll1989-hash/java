...
public class EchoServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        //channel.writeAndFlush(Unpooled.copiedBuffer("路路",CharsetUtil.UTF_8));

        //第二种
        //ChannelPipeline channelPipeline = ctx.pipeline();
        //channelPipeline.writeAndFlush(Unpooled.copiedBuffer("lucien",CharsetUtil.UTF_8));

        //第三种
        ctx.writeAndFlush(Unpooled.copiedBuffer("lucien",CharsetUtil.UTF_8));
